...
PICS = (environ.get('PICS', 'https://envs.sh/fDl.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001660912346').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channels = environ.get('AUTH_CHANNELS', '-1002022125199 -1001739519398 -1001938953663').split()  # Add multiple channel IDs separated by spaces
AUTH_CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in auth_channels]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://suresv262:predvd@cluster0.w5qug.mongodb.net/?retryWrites=true&w=majority")   # IF Multiple Database Is False Then Fill Only This Database Url.
